...
<style>
:root{color-scheme:dark;--bg:#18181a;--chassis:#202022;--surface:#3b3b40;--well:#18181a;--hair:#39393e;--text:#ffffff;--muted:#b8b8b8;--accent:#00aaff;--accent-hi:#2bbaff;--ink:#041018;--ok:#5be8b3;--warn:#ffc75c;--hot:#ff7088;--gyr0:#3d8f6a;--trough:#1c1c1c;--r:4px;--rw:3px;--rm:2px;--plate:none}
...
.join-shell{width:min(480px,100%);margin:clamp(40px,10vh,100px) auto 0;padding:0;border-radius:var(--r);background:transparent;box-shadow:var(--plate)}.join-intro h1{margin:0 0 8px;font-size:clamp(36px,7vw,52px);font-weight:600;line-height:1.05;letter-spacing:-.02em}.join-intro p{margin:0;color:var(--muted)}.join-caption{display:block;margin-top:12px;color:var(--muted);font-size:11px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.join{display:flex;flex-direction:column;margin-top:32px;padding-top:24px;border-top:1px solid var(--hair)}.join label{margin-bottom:6px;color:var(--muted);font-size:11px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.join-input{display:flex;align-items:center;gap:8px;border-bottom:1px solid var(--surface)}.join-input:focus-within{border-bottom-color:var(--accent)}.join-input svg{width:16px;height:16px;flex-shrink:0;color:var(--muted)}
...
.stage{position:relative;margin-top:16px;padding:16px 14px 14px;border-radius:var(--r);background:var(--chassis);box-shadow:var(--plate)}.scope-head{display:flex;justify-content:space-between;gap:12px;color:var(--muted);font-size:11px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.scope{display:block;width:100%;height:120px;margin:10px 0 8px;border-radius:var(--rw);background:#101010}.scope-idle{margin:0 0 14px;color:var(--muted);font-size:12px}
...
@media(max-width:600px){body{padding:16px 12px calc(24px + env(safe-area-inset-bottom))}.nav{flex-wrap:wrap}.theme-toggle{width:44px;height:44px}.nav-link{min-height:44px}.join-shell{padding:0}.stage{padding:14px 12px 12px}.scope{height:100px}.desk{height:232px;gap:14px}.gate{left:12px;right:12px;bottom:12px;height:232px}.rail{width:6px}.lane{width:20px}.fader,.throw{width:48px}}
